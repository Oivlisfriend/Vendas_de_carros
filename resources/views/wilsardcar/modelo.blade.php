...
<html>
    ...
    <body>
        ...
        <div class="panel-e">
            <div class="form">
                <form action="{{ route('gestao.modelo.edit',['modelo'=>$model->id])}}" class="formulario" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <h1>Formulário</h1>
                    <input type="text" class="txt-email" name="modelo" id="modelo" value="{{$model->nome_modelo}}" placeholder="Modelo">
                    <select class="txt-email" name="marca" id="tipo">
        ...
        <div class="panelc">
            <div class="form">
                <form action="{{ route('gestao.modelo.store')}}" class="formulario" method="post" enctype="multipart/form-data">
                    @csrf
                    <h1>Formulário</h1>
                    <input type="text" class="txt-email" name="modelo" id="modelo" placeholder="Modelo">
                    <select class="txt-email" name="marca" id="marca">
                        @foreach ($marcas as $marca)
                            <option value="{{$marca->id}}">{{$marca->nome_marca}}</option>
                        @endforeach
                    </select>
        ...
        <main class="corpo">
            ...
            <section class="areamin1">
                <div class="tb">
                <h1 class="u-center-text">Modelos</h1>
                <table class="tabela">
                    <tbody>
                        <tr class="tli">
                            <td class="tcoluna">
                        ...
                        <tr class="tlinha">
                            ...
                            <td class="">
                                <a href="{{route('gestao.modelo',['modelo'=>$modelo->id])}}" class="btn btn-edit">
